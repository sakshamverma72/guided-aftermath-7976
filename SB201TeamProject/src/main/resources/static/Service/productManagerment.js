...
function handleProductManagement() {
    ...
    <button id="addProductBtn">Add Cart</button>
    <button id="viewProductsBtn">View All Carts</button>
    <button id="editProductBtn">Update Cart</button>
    <button id="deleteProductBtn">Delete Cart</button>
    <button id="viewProductsBtn">View All Carts by ID</button>
</div>
