...
import com.masai.Service.AdminServicesInterfaceImplementation;
...
public class AdminController {
	@Autowired
	private AdminServicesInterfaceImplementation adminServices;
...
//	:::GETTING:::
	...
	public ResponseEntity<Customer> getCustomerByEmail(@PathVariable("email") String email) throws AdminException {
		log.info("Admin is fetching customer by email");
		Customer customer=adminServices.getCustomerByEmail(email);
		return new ResponseEntity<Customer>(customer,HttpStatus.OK);
	}
	@GetMapping("/admin/categories")
	public ResponseEntity<List<Category>> getAllCategory() throws AdminException {
		log.info("Admin is fetching categories");
		List<Category>categories=adminServices.getAllCategory();
		return new ResponseEntity<List<Category>>(categories,HttpStatus.OK);
	}
	@GetMapping("/admin/products")
	public ResponseEntity<List<Product>> getAllProducts() throws AdminException {
		log.info("Admin is fetching categories");
		List<Product>products=adminServices.getAllProduct();
		return new ResponseEntity<List<Product>>(products,HttpStatus.OK);
	}
	@GetMapping("/admin/orders")
	public ResponseEntity<List<Orders>> getAllOrders() throws AdminException {
	...
	public ResponseEntity<List<Orders>> getAllOrdersOfCustomer(@PathVariable("customerId") Integer customerId ) throws AdminException {
...
//	:::ORDER:::
	...
	public ResponseEntity<Orders> deleteOrder(@PathVariable("orderId") Integer orderId ) throws AdminException {
...
//	:::ADMIN:::
	...
	public ResponseEntity<Admin> updateAdmin(@PathVariable("adminId") Integer adminId,@RequestBody @Valid Admin admin) throws AdminException {
	...
	public ResponseEntity<Admin> deleteAdmin(@PathVariable("adminId") Integer adminId) throws AdminException {
		log.info("Admin is Deleteing another Admin");
...
//	:::PRODUTC:::
	...
	public ResponseEntity<Product> addProduct(@PathVariable("categoryId") Integer cateId,@RequestBody @Valid Product product) throws AdminException {
	...
	public ResponseEntity<Product> updateProduct(@PathVariable("productId") Integer productId,@RequestBody @Valid Product product) throws AdminException {
	...
	public ResponseEntity<Product> deleteProduct(@PathVariable("productId") Integer productId) throws AdminException {
...
//	:::CATEGORY:::
	...
	public ResponseEntity<Category> addCategory(@RequestBody @Valid Category category) throws AdminException {
	...
	public ResponseEntity<Category> updateCategory(@PathVariable("categoryId") Integer categoryId,@RequestBody @Valid Category category) throws AdminException {
	...
	public ResponseEntity<Category> deleteCategory(@PathVariable("categoryId") Integer categoryId) throws AdminException {
		log.info("Admin is Deleting a Category");
	...
	public ResponseEntity<List<Category>> getAllCategories() throws AdminException {
...
//	:::CUSTOMER:::
	...
	public ResponseEntity<Customer> ChangeRoleCustomer(@PathVariable("customerId") Integer customerId , @RequestBody Customer cutomerr) throws AdminException {
	...
	public ResponseEntity<Customer> deleteCustomer(@PathVariable("customerId") Integer customerId) throws AdminException {
